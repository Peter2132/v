...
namespace CreateApi.Controllers
{
    ...
    public class AppointmentDocumentsController : ControllerBase
    {
        ...
        public AppointmentDocumentsController(pract10Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<AppointmentDocument>> PostAppointmentDocument(AppointmentDocument appointmentDocument)
        {
          if (_context.AppointmentDocuments == null)
          {
              return Problem("Entity set 'pract10Context.AppointmentDocuments'  is null.");
          }
        ...
        {
            return (_context.AppointmentDocuments?.Any(e => e.IdAppointmentDocument == id)).GetValueOrDefault();
        }
    }
}
